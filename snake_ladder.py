...
def Move(Player, value, P1N, P2N, P3N, P4N):
    ...
    if num in snake_squares:
        print("You got bitten by a snake and is now on square", snake_squares[num])
        num = snake_squares[num]
    elif num in ladder_squares:
        print("You climbed a ladder and is now on square", ladder_squares[num])
...
def Player_Names(NumP):
    ...
    for i in range(1,NumP+1):
        Names.append(input("Player name"+str(i)+"?"))
    Names.append("")
    return Names
